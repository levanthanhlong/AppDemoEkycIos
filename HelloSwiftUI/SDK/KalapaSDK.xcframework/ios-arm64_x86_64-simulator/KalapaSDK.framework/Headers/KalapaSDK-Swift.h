...
- (KLPConfig * _Nonnull)withQRCodeStepWithMrz:(NSString * _Nullable)mrz qrCodeHandler:(void (^ _Nonnull)(NSString * _Nonnull, void (^ _Nonnull)(Result * _Nonnull)))qrCodeHandler;
...
/// Process  QRCode payload
/// \param payload payload
///
/// \param completion a closure function that is used to handle the result of the submit payload QRCode data
///
- (void)processQRCodeDataWithPayload:(NSString * _Nonnull)payload completion:(void (^ _Nonnull)(Result * _Nonnull))completion;
@end
